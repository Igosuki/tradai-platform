...
impl BittrexApi {
    ...
    pub fn new(creds: &dyn Credentials) -> Result<BittrexApi> {
        if creds.exchange() != Exchange::Bittrex {
            return Err(Error::InvalidConfigType {
                expected: Exchange::Bittrex,
                find: creds.exchange(),
            });
        }
    ...
    async fn public_query(&self, method: &str, params: &mut HashMap<&str, &str>) -> Result<Map<String, Value>> {
        strip_empties(params);
        let url = "https://bittrex.com/api/v1.1".to_string() + method + "?" + &url_encode_hashmap(params);
    ...
    async fn private_query(&self, method: &str, params: &mut HashMap<&str, &str>) -> Result<Map<String, Value>> {
        ...
        let base_url =
            "https://bittrex.com/api/v1.1".to_string() + method + "?apikey=" + &self.api_key + "&nonce=" + &nonce;

        let url = if params.is_empty() {
            base_url
        } else {
            base_url + "&" + &url_encode_hashmap(params)
        };
        ...
        let signature = HEXLOWER.encode(mac.finalize().into_bytes().as_slice());
    ...
    /// }
    /// ```
    pub async fn get_markets(&self) -> Result<Map<String, Value>> {
    ...
    /// }
    /// ```
    pub async fn get_ticker(&self, market: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
    ...
    /// }
    /// ```
    pub async fn get_market_summary(&self, market: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("market", market);
    ...
    /// }
    /// ```
    pub async fn get_order_book(&self, market: &str, order_type: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("market", market);
    ...
    /// }
    /// ```
    pub async fn get_market_history(&self, market: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("market", market);
    ...
    /// }
    /// ```
    pub async fn buy_limit(&self, market: &str, quantity: &str, rate: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("market", market);
    ...
    /// }
    /// ```
    pub async fn sell_limit(&self, market: &str, quantity: &str, rate: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("market", market);
        params.insert("quantity", quantity);
        params.insert("rate", rate);
    ...
    /// }
    /// ```
    pub async fn cancel(&self, uuid: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
    ...
    /// }
    /// ```
    pub async fn get_open_orders(&self, market: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("market", market);
    ...
    /// }
    /// ```
    pub async fn get_balances(&self) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
    ...
    /// }
    /// ```
    pub async fn get_balance(&self, currency: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
    ...
    /// }
    /// ```
    pub async fn get_deposit_address(&self, currency: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("currency", currency);
    ...
    /// }
    /// ```
    pub async fn get_order(&self, uuid: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("uuid", uuid);
    ...
    /// }
    /// ```
    pub async fn get_order_history(&self, market: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("market", market);
    ...
    /// }
    /// ```
    pub async fn get_withdrawal_history(&self, currency: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("currency", currency);
    ...
    /// }
    /// ```
    pub async fn get_deposit_history(&self, currency: &str) -> Result<Map<String, Value>> {
        let mut params = HashMap::new();
        params.insert("currency", currency);
