...
Therefore, it is critical that a single process runs only code owned by the runner, for instance for security, two users should not be able to access strategies from other users on the same machine. 
