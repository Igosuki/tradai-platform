...
impl Dispersion {
    ...
    pub fn update(&mut self, prev_mean: f64, new_mean: f64, new_value: f64, value_count: u64) {
        ...
        self.recurrence_relation_m =
            calculate_recurrence_relation_m(self.recurrence_relation_m, prev_mean, new_value, new_mean);

        // Update Population Variance
        self.variance = calculate_population_variance(self.recurrence_relation_m, value_count);
...
impl Range {
    ...
    pub fn calculate(&self) -> f64 { self.high - self.low }
}
