...
mod tests {
    ...
    fn calculate_mean_test() {
        ...
        for (input, expected) in inputs.iter().zip(expected.into_iter()) {
            let actual = calculate_mean(input.prev_mean, input.next_value, input.count);
    ...
    #[test]
    fn calculate_recurrence_relation_m_test() {
        struct Input {
            prev_m: f64,
            prev_mean: f64,
            new_value: f64,
    ...
    #[test]
    fn calculate_sample_variance_test() {
    ...
    #[test]
    fn calculate_population_variance_test() {
