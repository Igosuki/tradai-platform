use crate::summary::pnl::PnLReturnSummary;

pub trait Ratio {
    fn init(risk_free_return: f64) -> Self;
    fn ratio(&self) -> f64;
    fn trades_per_day(&self) -> f64;
    fn daily(&self) -> f64 { calculate_daily(self.ratio(), self.trades_per_day()) }
    fn annual(&self, trading_days: u32) -> f64 { calculate_annual(self.ratio(), self.trades_per_day(), trading_days) }
}
...
impl Ratio for SharpeRatio {
    ...
    fn ratio(&self) -> f64 { self.sharpe_ratio_per_trade }

    fn trades_per_day(&self) -> f64 { self.trades_per_day }
}
...
impl Ratio for SortinoRatio {
    ...
    fn ratio(&self) -> f64 { self.sortino_ratio_per_trade }
...
impl Ratio for CalmarRatio {
    ...
    fn ratio(&self) -> f64 { self.calmar_ratio_per_trade }
