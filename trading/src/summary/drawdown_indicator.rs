use crate::dispersion::Range;
use crate::math::welford::calculate_mean;
use chrono::{DateTime, Duration, Utc};
use trading::position::EquityPoint;
...
impl Drawdown {
    ...
    fn is_waiting_for_peak(&self) -> bool { self.drawdown == 0.0 }
...
impl AvgDrawdown {
    ...
    pub fn update(&mut self, drawdown: &Drawdown) {
        ...
        self.mean_drawdown = calculate_mean(self.mean_drawdown, drawdown.drawdown, self.count as f64);

        self.mean_duration_milliseconds = calculate_mean(
